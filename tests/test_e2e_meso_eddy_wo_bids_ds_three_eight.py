...
# ground_truth = json.load(open("benchmark_macos_arm64/D2_meso_eddy_wo_bids.json"))
# ground_truth = json.load(open("benchmark_linux_x86_64/D2_meso_eddy_wo_bids.json"))
# ground_truth = json.load(open("benchmark_windows_x86_64/D2_meso_eddy_wo_bids.json"))

test_dir = Path("tests/")
data_dir = test_dir / "data/D2_0.38/"
scratch_dir = test_dir / "tmp_D2_0.38_wo_bids/"
